...
<div class="container-fluid category-content-wrapper">
    <form id="product-add-form" method="post" action="{{ route('admin.pages.update', ['page' => $page]) }}">
        @csrf
        <div class="row">
            <div class="col-12">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.pages.index') }}">
                                {{ __('app.pages.all-pages') }}
                            </a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('app.pages.edit-title') }}
                        </li>
                    </ol>
                </nav>
            </div>

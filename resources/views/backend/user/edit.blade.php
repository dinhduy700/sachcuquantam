...
@section('backend-content-wrapper')
    <div class="container-fluid user-add-wrapper">
        <form id="product-add-form" method="post" action="{{ route('admin.users.update', ['user' => $user]) }}">
            @csrf
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active" aria-current="page">{{ __('app.users.edit-title') }}</li>
                        </ol>
                    </nav>
                </div>

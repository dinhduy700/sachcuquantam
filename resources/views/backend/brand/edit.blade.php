...
<div class="container-fluid category-content-wrapper">
    <form id="product-add-form" method="post" action="{{ route('admin.brands.update', ['brand' => $brand]) }}">
        @csrf
        <div class="row">
            <div class="col-12">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.brands.index') }}">
                                {{ __('app.brands.all-brands') }}
                            </a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('app.brands.edit-title') }}
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="col-12 d-flex justify-content-between align-items-center mb-4" id="fix-header-content">
                <div class="content-title">
                    <h2>{{ __('app.brands.edit-title') }}</h2>
                </div>

...
<div class="container-fluid category-content-wrapper">
    <form id="product-add-form" method="post" action="{{ route('admin.news.store') }}">
        @csrf
        <div class="row">
            <div class="col-12">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.news.index') }}">
                                {{ __('app.news.all-news') }}
                            </a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('app.news.add-title') }}
                        </li>
                    </ol>
                </nav>
            </div>
